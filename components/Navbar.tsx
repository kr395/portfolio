...
export const Navbar = ({ scrollToSection }: NavbarProps) => {
  ...
  const initialSection = pathname?.startsWith("/journey") ? "journey" : "home";
  const [activeSection] = useState<string>(initialSection);
  ...
  return (
    <nav className="bento-cell w-full z-30 px-6 md:px-10 lg:px-14 py-4 flex flex-col justify-center select-none transition-colors duration-300">
      <div className="flex justify-between items-center w-full">
        ...
        <div className="hidden md:flex gap-8 text-xs font-bold font-mono-technical items-center tracking-wide">
          <button
            onClick={() => handleNavClick("hero")}
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/journey"
            className="hidden md:block border border-[rgb(var(--primary-rgb))] text-xs font-bold px-5 py-2 text-[rgb(var(--primary-rgb))] bg-[rgb(var(--primary-rgb))]/5 hover:bg-[rgb(var(--primary-rgb))]/20 transition-all font-mono-technical tracking-wide"
          >
            HIRE ME
          </Link>
